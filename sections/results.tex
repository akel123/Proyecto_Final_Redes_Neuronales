...
\begin{figure}[h!]
    ...
    \caption{Eficacia de JPEG contra FGSM en una red especifica para CIFAR-10.}
    \label{cifar_acc_eps}
\end{figure}

\begin{figure}[h!]
    \centering
    \includegraphics[width=0.5\textwidth]{images/CW/cw_acc_le.png}
    \caption{Eficacia de JPEG contra Carlini-Wagner en LeNet.}
    \label{cw_acc}
\end{figure}
