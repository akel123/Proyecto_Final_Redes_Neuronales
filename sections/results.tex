...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{images/mnist/ffts.png}
    \caption{the noise can be seen in the fft of the adversarial image}
\end{figure}
...
En la Figura \ref{frog_ruidos} se muestran las transformadas rápidas de Fourier (FFTs) en 2D de los ruidos generados por el FGSM y el FGM, y se observa que ambas FFTs son muy similares a pesar de que los ruidos parecen distintos por la capa gris del FGM.
